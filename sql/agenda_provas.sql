...
CREATE TABLE `provas` (
  ...
  KEY `fk_idmaterias_idx` (`idmaterias`),
  KEY `fk_idusuario1` (`idusuario`),
  CONSTRAINT `fk_idmaterias` FOREIGN KEY (`idmaterias`) REFERENCES `materias` (`idmaterias`),
...
INSERT INTO `provas` VALUES (4,'2024-02-07','22:21:00',8.00,'prova de ligação covalente',7,43),(6,'2024-02-21','12:13:00',8.00,'cubismo',10,44);
